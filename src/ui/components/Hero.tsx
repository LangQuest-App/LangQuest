...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(fetchUsername, 100);
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 fade-in-up">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                Experience AI-powered language learning with personalized
                courses and immersive conversation practice in real-world
                scenarios.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative float-animation">
              ...
              {/* Floating Elements */}
              <div
                className="absolute -top-4 -left-4 bg-accent/90 backdrop-blur-sm rounded-full p-3 shadow-lg float-animation"
              ...
              <div
                className="absolute -bottom-4 -right-4 bg-secondary/90 backdrop-blur-sm rounded-full p-3 shadow-lg float-animation"
              ...
              <div
                className="absolute top-1/2 -right-6 bg-primary/90 backdrop-blur-sm rounded-full p-3 shadow-lg float-animation"
