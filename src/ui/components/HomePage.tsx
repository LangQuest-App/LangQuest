            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 font-family-fredoka">
                <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-snug tracking-tight mb-2">
                  Master Any <span className="bg-gradient-to-r from-[#45BB19] via-emerald-500 to-green-600 bg-clip-text text-transparent animate-pulse">Language</span>
                </h1>
                <h2 className="text-3xl lg:text-4xl font-semibold text-gray-800 mb-1">Naturally</h2>
              ...
              <p className="text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl">
                Join millions learning languages through immersive conversations with our AI-powered frog companion. <span className="font-semibold text-gray-700">Experience the future of language learning today.</span>
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-lg p-2.5 shadow-md border border-green-100/40 h-12 min-h-0">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-base">40+ Languages</p>
                ...
                <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-lg p-2.5 shadow-md border border-green-100/40 h-12 min-h-0">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-base">AI-Powered</p>
                ...
                <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-lg p-2.5 shadow-md border border-green-100/40 h-12 min-h-0">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-base">5M+ Users</p>
              ...
              <div className="flex items-center space-x-4 pt-2">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="ml-2 text-sm font-medium text-gray-700">4.9/5 from 50k+ reviews</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative p-8">
                ...
                <div className="w-full max-w-lg mx-auto">
                  <img src={FrogBook} alt="Frog Reading a Book" className="w-full h-auto rounded-3xl" />
                </div>
                ...
                <div className="absolute top-8 left-8 bg-gradient-to-r from-white via-emerald-50 to-green-100 rounded-xl px-4 py-2 shadow-lg border border-emerald-100/60">
                  <span className="text-sm font-medium text-emerald-700">¡Hola!</span>
                </div>
                <div className="absolute top-20 right-8 bg-gradient-to-r from-white via-green-50 to-emerald-100 rounded-xl px-4 py-2 shadow-lg border border-green-100/60">
                  <span className="text-sm font-medium text-green-700">Bonjour!</span>
                </div>
                <div className="absolute bottom-16 left-24 bg-gradient-to-r from-white via-teal-50 to-green-100 rounded-xl px-4 py-2 shadow-lg border border-teal-100/60">
                  <span className="text-sm font-medium text-teal-700">こんにちは!</span>
                </div>
                <div className="absolute bottom-8 right-24 bg-gradient-to-r from-white via-yellow-50 to-orange-100 rounded-xl px-4 py-2 shadow-lg border border-yellow-100/60 ">
                  <span className="text-sm font-medium text-yellow-700">नमस्ते!</span>
                </div>
                <div className="absolute top-1/2 left-3 -translate-x-1/2 bg-gradient-to-r from-white via-pink-50 to-purple-100 rounded-xl px-4 py-2 shadow-lg border border-pink-100/60 ">
                  <span className="text-sm font-medium text-pink-700">নমস্কার!</span>
                </div>
              </div>
            </div>
          </div>
